...
pub(crate) use git_diff::{
    ...
    git_diff, git_log, git_op, git_repositories_with_options, git_repository_statuses,
    git_resources, git_status, read_git_diff, validate_git_repository_root, GitBranchesResponse,
