...
pub(crate) fn tool_description(name: &str, fallback: &str) -> String {
    let description = match name {
        ...
        "session_probe" => t("Inspect sessions and their holders.", "查看会话及其持有者。"),
        "agent_probe" => t("Inspect subagents without disturbing them.", "查看子智能体而不打扰它们。"),
        "mesh_send" => t("Send a message to a session or subagent.", "向会话或子智能体发送消息。"),
        "mesh_recv" => t("Read messages sent to this session.", "读取发给本会话的消息。"),
        "mesh_reply" => t("Answer a received mesh message.", "回复收到的网格消息。"),
